...
const caloriesConsumed = dayLog?.total_calories || 0;
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-mint">
      ...
      <div className="flex-1 overflow-y-auto md:pt-0" style={{ paddingTop: 'calc(110px + env(safe-area-inset-top, 0px))', paddingBottom: 'calc(220px + env(safe-area-inset-bottom))' }}>
