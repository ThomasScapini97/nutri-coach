      ...
      <div className="bg-white rounded-3xl shadow-lg transition-all">
        ...
        <div className="px-4 pb-3">
          <div className="relative h-2 bg-gray-200 rounded-full overflow-hidden">
            <motion.div initial={{ width: 0 }} animate={{ width: `${caloriePercentage}%` }} transition={{ duration: 0.8 }} className={cn("h-full rounded-full", isDanger ? "bg-destructive" : isWarning ? "bg-accent" : "bg-rose-500")} />
          </div>
        </div>
