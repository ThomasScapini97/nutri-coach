...
export default function AnimatedProgressBar({ label, value, max, unit, icon: Icon, color = "primary" }) {
  ...
  const bgColor = isDanger ? "bg-destructive/10" : isWarning ? "bg-accent/10" : color === "chart-4" ? "bg-red-400/10" : color === "chart-3" ? "bg-amber-400/10" : color === "blue-500" ? "bg-blue-500/10" : "bg-primary/10";
